	...
	<div class="calendar-list-container nav-content">
		<div ref="searchSection" class="search-info page-info" style="padding-bottom:0;">
			<div class="search-left">
				<el-form :inline="true" :model="listQuery" @keyup.enter.native="getList()">
					...
					<el-form-item>
						<el-input clearable placeholder="请输入谈话人关键字查询" v-model="listQuery.talkUserName">
						</el-input>
					</el-form-item>
					<el-form-item>
						<el-input clearable placeholder="请输入被谈话人关键字查询" v-model="listQuery.beTalkUserName">
						</el-input>
					</el-form-item>
					<el-form-item>
		...
		<div class="page-info" ref="pageInfo">
			<el-table :height="tableHeight" ref="table" :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
				...
				<el-table-column header-align="center" align="center" label="谈话人">
					<template slot-scope="scope">
				...
				<el-table-column header-align="center" align="center" label="被谈话人" :show-overflow-tooltip="true">
					<template slot-scope="scope">
	...
	export default {
		...
		methods: {
			...
			tableLayout(option) {
				...
				this.tableHeight = computedHeight > 380 ? computedHeight : 380
				this.$nextTick(() => {
