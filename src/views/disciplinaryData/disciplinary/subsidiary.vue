		...
		<div class="search-info page-info">
			<div class="search-left">
				<el-form :inline="true" :model="listQuery" @keyup.enter.native="getDataList()">
					...
					<el-button class="filter-item" v-waves icon="search" @click="handleFilter" style="margin-left: 10px;">查询</el-button>
				</el-form>
			</div>
		</div>
		...
		<div class="page-info" ref="pageInfo" style="margin-left: 310px;">
            <div class="radio-group">
				...
				<el-form v-if="tabPosition == '单位风险点排查'" class="radio-group-form" :inline="true">
                    <el-form-item label="档案编号：">
                        <el-input clearable placeholder="请输入档案编号" v-model="archivesNumScreening" :readonly="isReadonlyScreening">
                        </el-input>
                    </el-form-item>
